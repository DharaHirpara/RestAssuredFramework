...
public void testPostUser(){//test method
		...
		Response response = UserEndPoints2.createUser(userPayload);//call createUser method of UserEndPoints class 
	...
	public void testGetUserByName(){//test method
		...
		logger.info( "**************Reading user Info **********************");
			Response response = UserEndPoints2.readUser(this.userPayload.getUsername());//here we will not pass payload but extract username from payload
	...
	public void testupdateUserByName(){//update  data of this userName by using paylaod
		...
		userPayload.setEmail(faker.internet().safeEmailAddress());
			...
			Response response = UserEndPoints2.updateUser(this.userPayload.getUsername(),userPayload);//here we will not pass payload but extract username from payload
			//whatever payload generate above pass usename from it here
		...
		//or	
			...
			Response responseAfterUpdate = UserEndPoints2.readUser(this.userPayload.getUsername());//here we will not pass payload but extract username from payload
			//whatever payload generate above pass usename from it here
	...
	public void testdeleteUserByName(){//update  data of this userName by using paylaod,this is testng assertion
		...
		logger.info( "**************Deleting User **********************");
			...
			Response response = UserEndPoints2.deleteUser(this.userPayload.getUsername());//here we will not pass payload but extract username from payload
			//whatever payload generate above pass usename from it here
